<h2><a href="https://leetcode.com/problems/largest-integer-with-given-digit-sum">Largest Integer With Given Digit Sum</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given two non-negative integers <code>n</code> and <code>s</code>.</p>
